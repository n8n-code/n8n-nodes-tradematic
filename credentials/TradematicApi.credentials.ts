...
export class TradematicApi implements ICredentialType {
	name = 'N8nDevTradematicApi';

	displayName = 'tradematic API';

	icon: Icon = { light: 'file:../nodes/Tradematic/tradematic.png', dark: 'file:../nodes/Tradematic/tradematic.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your tradematic API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
